...
public:
	...
	bool GetRotateWhenDraw()const{ return _rotate; }
	...
	void SetRotateWhenDraw(bool rotate){ _rotate=rotate; }
	...
	virtual void Create(double x, double y, //誕生時の座標
				...
				double drawExp = 1.0, int drawParam = 255, bool deletable = true, bool rotateWhenDraw=true);
	virtual void Move();
	virtual void Draw();
